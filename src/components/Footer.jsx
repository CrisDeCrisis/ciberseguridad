...
const Footer = () => {
  return (
    <footer className="bg-violet-950 text-white py-6 shadow-md shadow-violet-900">
      <div className="max-w-4xl mx-auto text-center">
        <div className="max-w-4xl mx-auto text-center group cursor-pointer">
            <h2 className="text-lg font-semibold mb-2 tracking-wide transition-all duration-500 transform group-hover:text-amber-300">Integrantes del Proyecto</h2>
        </div>
