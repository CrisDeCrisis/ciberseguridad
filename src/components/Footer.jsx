...
const Footer = () => {
    ...
    return (
        ...
        <footer className="bg-gradient-to-r from-violet-950 via-violet-900 to-violet-950 text-white py-3 shadow-md shadow-violet-900">
            <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-xs text-gray-400 mt-4">
                    © {new Date().getFullYear()} Cloud Cybersecurity. Todos los derechos reservados.
                </p>
            </div>
        </footer>
